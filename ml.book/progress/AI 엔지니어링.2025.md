...
### 6.1 RAG
  * 검색 후 생성: retrieve-then-generate
  * 검색 증강 생성: retrieval-augmented generation for knowledge-intensive NLP tasks
* 6.1.1 RAG 아키텍처
* 6.1.2 검색 알고리즘
  * 용어 기반: tf-idf, inverted index, n-gram
  * 임베딩 기반: 의미 기반, 벡터 DB
* 6.1.3 검색 최적화
* 6.1.4 텍스트를 넘어선 RAG
