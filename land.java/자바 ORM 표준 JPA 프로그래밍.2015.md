...
## 10장. 객체지향 쿼리 언어
* 10.1 객체지향 쿼리 소개
  * 10.1.1 JPQL 소개: 객체지향 쿼리
  * 10.1.2 Criteria 쿼리 소개: JPQL 편의 제공을 위한 api, 빌더 모음
  * 10.1.3 QueryDSL 소개: JPA 공식 지원 아님, 가장 편의성 높음
  * 10.1.4 네이티브 SQL 소개: JPA에서 직접 SQL 사용
